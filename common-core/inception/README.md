...
- **Docker Volumes vs Bind Mounts**: Bind mounts into host directories (`/home/${USERNAME}/data/...`) make data visible on the host for backups and inspection.
...
- AI usage: AI was used to draft documentation, summarize configuration choices, sanity-check commands, and assist with a few shell/bash commands
