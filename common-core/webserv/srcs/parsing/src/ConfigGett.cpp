...
const std::string* ConfigGett::getErrorPage(int port, const std::string& error,
    ...
    if (it != MapNode.end()) {
        ...
        std::map<std::string, std::vector<std::string> >::const_iterator
            itChildren = current->prmtrs.begin();
...
const std::string* ConfigGett::getErrorPage(int                port,
